...
import { createLegacy } from "../utils/helpers";
...
const Form = () => {
  ...
  const [userNextOfKinEns, setUserNextOfKinEns] = useState('');
  ...
  const handleChaneEnsName = (event) => {
    setUserNextOfKinEns(event.target.value);
  }
        ...
        <form>
          ...
          >
            <TextInput
              ...
              disabled={userNextOfKinEns}
              bg="none"
            />
            <Box>
              <Text color="white" mt="-10px" mb="-15px">or</Text>
              <TextInput
                label="Next of kin ENS name"
                placeholder="Enter your next of kin ENS name"
                type="text"
                color="brand.white"
                onChange={handleChaneEnsName}
                value={userNextOfKinEns}
                disabled={legatee}
                bg="none"
              />
            </Box>
